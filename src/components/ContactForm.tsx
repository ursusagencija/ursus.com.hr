            ...
            <form action="#">
                <div className="grid grid-cols-2 gap-base">
                    ...
                    <div className="col-span-2">
                        <input type="email" placeholder="Your Email" className="input_style__primary" />
                    </div>
                    <div className="col-span-2">
                        <textarea cols={30} rows={6} className="input_style__primary" placeholder="Your Message..." defaultValue={""} />
                    </div>
                    <div className="col-span-2">
