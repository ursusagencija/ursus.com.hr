...
export default function ContentBlock({ children }: { children: any }) {
    const components = {
        'paragraph': ({ children }: { children: any }) => <p className="py-2 text-md">{children}</p>,
        ...
        'strong': ({ children }: { children: any }) => <strong className=" text-dark-2 font-medium leading-[1.5] font-sans mb-6">{children}</strong>,
