...
export default function TransferContactForm() {
    return (<div className='my-8'>
        ...
        <form action="#" autoComplete="off" className="lg:px-base px-5 lg:pt-6 lg:pb-base pt-4 pb-5 bg-white border-primary-1 border">
            ...
            <h4 className="lg:text-xl text-lg text-dark-1 font-semibold"><LocalizeText croatianText='Upit za transfer' englishText='Transfer Request' /></h4>


            <div className='grid md:grid-cols-3 gap-x-4'>
                <div className="mt-5 lg:mt-6">
                    <label htmlFor="name" className="mb-2 text-dark-3 capitalize block"><LocalizeText croatianText='Name' englishText='Name' /></label>
                    <input type="text" id="name" name="name" className="input_style__primary" />
                </div>

                <div className="mt-5 lg:mt-6">
                    <label htmlFor="flyingFrom" className="mb-2 text-dark-3 capitalize block"><LocalizeText croatianText='Flying From' englishText='Flying From' /></label>
                    <input type="text" id="flyingFrom" name="flyingFrom" className="input_style__primary" />
                </div>

                <div className="mt-5 lg:mt-6">
                    <label htmlFor="flyingTo" className="mb-2 text-dark-3 capitalize block"><LocalizeText croatianText='Flying To' englishText='Flying To' /></label>
                    <input type="text" id="flyingTo" name="flyingTo" className="input_style__primary" />
                </div>

                <div className="mt-5 lg:mt-6">
                    <label htmlFor="flightDateTime" className="mb-2 text-dark-3 capitalize block"><LocalizeText croatianText='Flight Date and Time' englishText='Flight Date and Time' /></label>
                    <input type="datetime-local" id="flightDateTime" name="flightDateTime" className="input_style__primary" />
                </div>

                <div className="mt-5 lg:mt-6">
                    <label htmlFor="flightNumber" className="mb-2 text-dark-3 capitalize block"><LocalizeText croatianText='Flight Number' englishText='Flight Number' /></label>
                    <input type="text" id="flightNumber" name="flightNumber" className="input_style__primary" />
                </div>

                <div className="mt-5 lg:mt-6">
                    <label htmlFor="passengerCount" className="mb-2 text-dark-3 capitalize block"><LocalizeText croatianText='Number of Passengers' englishText='Number of Passengers' /></label>
                    <input type="number" id="passengerCount" name="passengerCount" className="input_style__primary" />
                </div>

                <div className="mt-5 lg:mt-6">
                    <label htmlFor="email" className="mb-2 text-dark-3 capitalize block"><LocalizeText croatianText='Email' englishText='Email' /></label>
                    <input type="email" id="email" name="email" className="input_style__primary" />
                </div>

                <div className="mt-5 lg:mt-6">
                    <label htmlFor="phoneNumber" className="mb-2 text-dark-3 capitalize block"><LocalizeText croatianText='Phone Number' englishText='Phone Number' /></label>
                    <input type="tel" id="phoneNumber" name="phoneNumber" className="input_style__primary" />
                </div>
            </div>

            <div className="mt-5 lg:mt-6">
                <label htmlFor="additionalInfo" className="mb-2 text-dark-3 capitalize block"><LocalizeText croatianText='Additional Information' englishText='Additional Information' /></label>
                <textarea id="additionalInfo" name="additionalInfo" className="input_style__primary" />
            </div>
