        ...
        <>
            <form action="#" className="container z-10" autoComplete="off">
                <div className="flex items-center lg:flex-row flex-col space-y-4 lg:space-y-0 lg:space-x-base">
                    ...
                    <button type="submit" className="block lg:w-auto w-full flex-grow text-center bg-primary-1 lg:h-17 h-14  font-medium text-md text-white hover:bg-secondary-1 duration-300">Show Available</button>
                </div>
            </form>
        </>
