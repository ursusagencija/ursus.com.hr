        ...
        <div>
            ...
            <div id="tab-3" className={`tab-content ${activTab === 'booking' ? 'active' : ''}`}>
                <form action="#" autoComplete="off" className="lg:px-base px-5 lg:pt-6 lg:pb-base pt-4 pb-5 bg-white border-primary-1 border">
                    <h4 className="lg:text-xl text-2xl text-primary-1 font-semibold"> <LocalizeText croatianText="Provjerite dostuponost" englishText="Check Availability" /></h4>
                    ...
                    <div className="js-form-counters lg:mt-6 mt-5 relative">
                        <label htmlFor="tourTime" className="mb-2 text-dark-3 capitalize block">Number of people</label>
