    ...
    <footer className="bg-gray-100 mt-12">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <ul className="mt-8 space-y-1 text-sm text-center text-gray-700">
          ...
          <li>
            <strong>{t("summer-season")}</strong>
            {""}({t("june-september")})
          </li>
          <li>{t("hours-summer")}</li>
          <li>
            <strong>{t("off-season")}</strong> ({t("october-may")})
          </li>
          <li>{t("hours-off")}</li>
        </ul>
        ...
        <div className="flex items-center justify-center mt-3 text-sm">
          {" "}
          <a href="https://killerclick.com">
            Web by:
            <br />
            <Image
              src="/assets/images/kc-logo.svg"
              alt="web by killer click"
              width={76}
              height={50}
              className="mx-auto"
            />
