                ...
                <div className="container relative z-2">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            <li><Link href="/tours"><LocalizeText croatianText="Izleti" englishText="Tours" /></Link></li>
                ...
                <div className="flex flex-wrap justify-between pb-8 pt-6 mb-8 border-b border-stock-1">
                    ...
                    <div className="pt-2  p-4">
                        <ul className="grid grid-cols-1 md:grid-cols-3">
                            <li className="flex items-center gap-2 px-2"><i className="bi bi-clock" /> {page.data.duration}</li>
                            <li className="flex items-center gap-2 px-2"> <i className="bi bi-person" />Min. age: {page.data.min_age}</li>
                            <li className="flex items-center gap-2 px-2"><i className="bi bi-map" />{page.data.location}</li>
                        </ul>
                        <h2 className="font-sans lg:text-[45px] leading-1.2 md:text-xl text-lg font-semibold">{page.data.price}€
                        </h2>
                    ...
                    <div className="lg:col-span-8 col-span-12">
                        <div className="pack__disc">
                            ...
                            <ul className="mt-base">
                                {includedItems.length > 0 && <li className="lg:flex lg:pt-6 pt-5 pb-5 lg:pb-6 border-t border-stock-1 last:border-b">
                                    <div className="lg:w-1/3 lg:text-2md text-md text-dark-2 font-medium">
                                        <LocalizeText croatianText="Uključuje" englishText="Includes" />
                                    </div>
                                ...
                                <li className="lg:flex lg:pt-6 pt-5 pb-5 lg:pb-6 border-t border-stock-1 last:border-b">
                                    <div className="lg:w-1/3 lg:text-2md text-md text-dark-2 font-medium">
                                        <LocalizeText croatianText="Ne uključuje" englishText="Excludes" />
                                    </div>
                                    <div className="lg:w-2/3 lg:mt-0 mt-4">
                            ...
                            <div className="lg:pt-10 pt-8">
                                <h3><LocalizeText croatianText="Itinerar" englishText="Itinerary" /></h3>
                            ...
                            <div className="pt-2">
                                <h3><LocalizeText croatianText="Često postavljana pitanja" englishText="Frequently Asked Questions" /></h3>
                                <Faq faqList={page.data.faq} />
                            </div>
                            <div className="lg:pt-10 pt-8">
                                <h3><LocalizeText croatianText="Galerija" englishText="Gallery" /></h3>
